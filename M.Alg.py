...
questions = ["Do you like dogs?", "Do you like cats?", "Do you like pizza?", "Do you like ice cream?", "Do you like beer?"]
...
def compare_answers(user_answers, random_answers):
    ...
    for i in range(len(user_answers)):
        ...
        if user_answers[i] == random_answers[i]:
